...
public class RenderEntityDriveEievui extends Render{
	...
	public RenderEntityDriveEievui(RenderManager renderManager) {
		super(renderManager);
    ...
    public void doRender(Entity entity, double d0, double d1, double d2, float f, float f1) {
		 if (entity instanceof EntityDriveEievui) {
			 doDriveRender((EntityDriveEievui) entity, d0, d1, d2, f, f1);
		 }
	}
	...
	private void doDriveRender(EntityDriveEievui entityDrive, double dX, double dY, double dZ, float f, float f1) {
