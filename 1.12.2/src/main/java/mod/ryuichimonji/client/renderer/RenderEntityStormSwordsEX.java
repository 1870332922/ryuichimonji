...
public class RenderEntityStormSwordsEX extends Render<EntityStormSwordsEX>{
	 ...
	 public RenderEntityStormSwordsEX(RenderManager renderManager){
	        super(renderManager);
	    }
	 
	 @Override
	public void doRender(EntityStormSwordsEX entity, double x, double y, double z, float entityYaw, float partialTicks){
	    ...
	    @Override
		protected ResourceLocation getEntityTexture(EntityStormSwordsEX entity){
	        return null;
	    }
}
