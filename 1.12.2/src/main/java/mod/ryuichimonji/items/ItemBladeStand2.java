...
public class ItemBladeStand2 extends Item{
	public ItemBladeStand2() {
		this.setUnlocalizedName(RyuIchimonji.MODID + "."+ "bladestandtype2");
		this.setRegistryName("bladestandtype2");
