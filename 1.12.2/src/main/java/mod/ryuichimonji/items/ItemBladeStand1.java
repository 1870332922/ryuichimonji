...
public class ItemBladeStand1 extends Item{
	public ItemBladeStand1() {
		this.setUnlocalizedName(RyuIchimonji.MODID + "."+ "bladestandtype1");
		this.setRegistryName("bladestandtype1");
