...
public class ItemBladeStand3 extends Item{
	public ItemBladeStand3() {
		this.setUnlocalizedName(RyuIchimonji.MODID + "."+ "bladestandtype3");
		this.setRegistryName("bladestandtype3");
