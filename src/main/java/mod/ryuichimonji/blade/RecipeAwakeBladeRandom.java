...
public class RecipeAwakeBladeRandom extends ShapedOreRecipe {

    ItemStack requiredStateBlade = ItemStack.EMPTY;

    public RecipeAwakeBladeRandom(ResourceLocation loc,ItemStack result, ItemStack requiredStateBlade, Object... recipe) {
	...
	public ItemStack getCraftingResult(InventoryCrafting var1) {
		...
		for(int idx = 0; idx < var1.getSizeInventory(); idx++){
			...
			if(!curIs.isEmpty()
                ...
                ItemSlashBlade.TextureName.set(newTag, ItemSlashBlade.TextureName.get(newTag) + (int)(Math.random()*3));
