...
public class RenderEntitySlashBladeLightningBolt extends Render<EntitySlashBladeLightningBolt>{
	
	public RenderEntitySlashBladeLightningBolt(RenderManager renderManagerIn){
        super(renderManagerIn);
    }
	
	public void doRender(EntitySlashBladeLightningBolt entity, double x, double y, double z, float entityYaw, float partialTicks){
                ...
                for (int i1 = k; i1 >= l; --i1){
                    ...
                    for (int j1 = 0; j1 < 5; ++j1){
                        ...
                        .color(((color >> 16) & 0xff)/255.0F,
                        		((color >>  8) & 0xff)/255.0F,
                        		((color      ) & 0xff)/255.0F, 0.3F).endVertex();
    ...
    @Nullable
    protected ResourceLocation getEntityTexture(EntitySlashBladeLightningBolt entity){
        return null;
    }
}
